    ...
    return(
       <main className="about" >
        ...
        <SimpleGrid columns={1} spacing={4}>
          ...
          Linkhon Hasan is a passionate software developer with a strong foundation in programming, honed through a Bachelor's Degree in Conputer Science from Southern New Hampshire University, a Full Stack Development certificate from Columbia University, and the FastTrack SpringBoot program at Cook Systems.
          </Text>
          <Text fontSize="xl" textAlign="justify">
